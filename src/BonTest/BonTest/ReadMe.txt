================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: BonTest プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した BonTest には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには BonTest アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
BonTest.h
   ...
   CBonTestApp アプリケーション クラスを宣言します。

BonTest.cpp
   これは、アプリケーション クラス CBonTestApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\BonTest.ico
   ...
   アイコンはメイン リソース ファイル BonTest.rc に含まれていま
   す。
...
BonTestDlg.h, BonTestDlg.cpp - ダイアログ
   これらのファイルは CBonTestDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な BonTest.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   BonTest.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
